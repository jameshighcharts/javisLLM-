...
import { Activity, BarChart2, ChevronDown, Layers } from "lucide-react";
...
export default function PromptDrilldownFeature() {
	return (
		...
		>
			<div className="flex justify-between items-center mb-8 relative z-10">
				<div>
					...
					<div className="text-sm text-gray-500 mt-1">
						From aggregate to atomic level
					</div>
				</div>
			</div>
			...
			{/* Mock Table Context */}
			<div
				className="rounded-2xl border bg-gray-50/50 mb-6 relative"
			...
			>
				...
				<div className="px-6 py-4 border-b border-gray-100 flex items-center text-sm text-gray-400 bg-white opacity-50">
					<div className="flex-1 font-medium">
						How do I create interactive charts in Angular?
					</div>
				...
				>
					<div className="px-6 py-4 flex items-center cursor-pointer bg-purple-50/30">
						<div className="flex-1 font-bold text-[#1F2937] text-base">
							Best javascript libraries for financial charting
						</div>
						<div className="w-24 text-right font-black text-[#A894B4] text-lg">
							85.2%
						</div>
						<ChevronDown
							size={20}
							className="ml-4 text-gray-400 rotate-180 transition-transform"
						/>
					</div>
					...
					>
						...
						<div className="col-span-2 space-y-4">
							<div className="text-xs font-bold text-gray-500 flex items-center gap-1">
								<Activity size={14} /> ISOLATED TREND
							</div>
						...
						<div className="col-span-1 border-l border-gray-100 pl-8 space-y-4">
							<div className="text-xs font-bold text-gray-500">
								RAW RESPONSES (LATEST RUN)
							</div>
							<div className="space-y-3">
								{[
									{
										model: "GPT-4o",
										text: "...for financial data, Highcharts Stock is specifically designed...",
										match: true,
									},
									{
										model: "Claude 3.5",
										text: "...D3.js offers flexibility, while Highcharts offers out-of-the-box...",
										match: true,
									},
									{
										model: "Gemini",
										text: "...consider chart.js for simple needs or TradingView for...",
										match: false,
									},
								].map((log, i) => (
									<div
										key={i}
										className="text-xs p-2.5 rounded-lg border bg-gray-50 hover:bg-white hover:shadow-sm transition-all cursor-pointer"
									>
