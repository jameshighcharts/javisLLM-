...
import { Server, Activity, DollarSign, Clock, Cpu } from 'lucide-react'
        ...
        <div className="w-full bg-white rounded-[32px] p-6 lg:p-8 border shadow-xl overflow-hidden font-sans relative perspective-1000" style={{ borderColor: 'rgba(221, 208, 188, 0.6)' }}>
            <div className="flex justify-between items-center mb-8 relative z-10">
                <div>
                    ...
                    <div className="text-sm text-gray-500 mt-1">Under the hood analytics</div>
                </div>
                <div className="flex gap-2">
                    <div className="bg-[#F9F8F6] rounded-lg border px-3 py-1.5 text-xs font-medium text-gray-500 shadow-sm flex items-center gap-1" style={{ borderColor: 'rgba(221, 208, 188, 0.4)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                ...
                >
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-400 tracking-wider mb-4"><DollarSign size={14} className="text-[#558A5E]" /> EST. RUN COST</div>
                    ...
                    <div className="text-xs text-gray-500 font-medium pb-2 border-b border-gray-200">Across 1,240 prompts</div>
                    ...
                    <div className="mt-4 space-y-2">
                        ...
                        <div className="flex justify-between text-xs">
                            <span className="text-gray-500 font-medium">Claude 3.5 Sonnet</span>
                ...
                >
                    ...
                    <div className="text-xs font-bold text-gray-400 tracking-wider mb-6 w-full flex items-center gap-2"><Activity size={14} className="text-[#D18880]" /> p95 LATENCY</div>

                    <div className="relative w-32 h-16 overflow-hidden flex justify-center mb-2">
                        <svg className="absolute w-32 h-32" viewBox="0 0 100 50" preserveAspectRatio="none">
                            ...
                            <motion.path
                                ...
                                fill="none" stroke="url(#latencyGradient)" strokeWidth="8" strokeLinecap="round"
                            />
                            <defs>
                    ...
                    <div className="text-2xl font-black text-[#2A3A2C] mt-2 font-mono">15.4s</div>
                    <div className="text-[10px] bg-red-100 text-red-700 px-2 py-0.5 rounded font-bold mt-1 shadow-sm">Web Search Impact</div>
                </motion.div>
                ...
                <motion.div
                    ...
                    style={{ borderColor: 'rgba(221, 208, 188, 0.3)' }}
                >
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-400 tracking-wider mb-4"><Cpu size={14} className="text-[#A894B4]" /> TOKEN USAGE</div>
