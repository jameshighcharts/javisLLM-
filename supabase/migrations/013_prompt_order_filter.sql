-- Add prompt ordering support for queue benchmark runs (default or newest first).

drop function if exists public.enqueue_benchmark_run(uuid, text[], text, int, numeric, boolean, int, text);
