...
async function resolveBaselineRunId(config, providedBaselineRunId) {
  ...
  if (provided) {
    ...
    if (!run?.ended_at) {
      const error = new Error('baselineRunId must reference a completed benchmark run.')
